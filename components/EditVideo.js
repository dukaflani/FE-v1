...
import { useCurrentVideoQuery, useFetchAccessTokenQuery, useFetchAllGenresQuery, 
...
const EditVideo = () => {
    ...
    const { data: currentVideo, isLoading } = useCurrentVideoQuery(currentVideoQueryParams)

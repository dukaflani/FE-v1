...
import SpinnerMobile from './SpinnerMobile';
...
const ProfilePageComponent = () => {
  ...
  if (isLoading) {
    return  <SpinnerMobile loadingStatement='Loading your profile'  /> 
  }
  ...
  return (
    <>
    <div className='flex flex-col items-center justify-center pt-20 mb-10 px-2'>
            <div className='bg-white border-b shadow-sm w-full md:max-w-sm landscape:max-w-sm mx-auto'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <div className='w-full p-2 flex flex-col items-center justify-start space-y-2'>

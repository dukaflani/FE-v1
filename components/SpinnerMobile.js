...
const SpinnerMobile = ({ loadingStatement }) => {
      ...
      <div className='h-screen w-screen flex items-start justify-center'>
        <div className='relative w-48 h-screen flex flex-col items-center justify-center'>
          <div role="status flex flex-col items-center justify-center">
              <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 flex items-center justify-center" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="sr-only">{loadingStatement}</span>
              <span className='text-gray-800 font-semibold text-sm tracking-tight'>{`${loadingStatement}...`}</span>
          </div>
        </div>
      </div>

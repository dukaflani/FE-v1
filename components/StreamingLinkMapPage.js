...
const StreamingLinkMapPage = () => {
  ...
  return (
    ...
    <div className='text-sm mb-5 tracking-tighter text-gray-700'>Click on the links below to stream or download {video?.details?.song_title} by {video?.details?.stage_name}</div>
        <StreamingLinkCard/>

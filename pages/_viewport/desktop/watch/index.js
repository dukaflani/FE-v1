  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`Watch ${currentVideo?.results[0]?.song_title} Song & Lyrics by ${currentVideo?.results[0]?.stage_name} - Dukaflani`} />
        ...
        <meta property="twitter:title" content={`Watch ${currentVideo?.results[0]?.song_title} Song & Lyrics by ${currentVideo?.results[0]?.stage_name} - Dukaflani`} />
